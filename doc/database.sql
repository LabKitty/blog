...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2014 at 12:06 PM
...
('root', '[{"db":"blog","table":"tag"},{"db":"blog","table":"post"},{"db":"blog","table":"comment"},{"db":"blog","table":"post_tags"},{"db":"blog","table":"user"},{"db":"phpmyadmin","table":"pma_column_info"},{"db":"phpmyadmin","table":"pma_designer_coords"},{"db":"phpmyadmin","table":"pma_history"},{"db":"phpmyadmin","table":"pma_pdf_pages"},{"db":"phpmyadmin","table":"pma_recent"}]');
...
('root', '2014-09-18 17:59:31', '{"collation_connection":"utf8mb4_general_ci"}');
